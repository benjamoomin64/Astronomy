...
namespace MathChecking
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            star.Spatial.Parallax = 0.04439;
            star.AbsoluteMagnitude = 1.58;
            star.FindOtherValues();

            Assert.IsTrue(MarginOfError(star.Spatial.Parallax, 22.53));
            Assert.IsTrue(MarginOfError(star.Spatial.Distance, distances[3].ToStandard(73.5)));
        ...
        public void TestMethod2()
        {
            ...
            star.FindOtherValues();
            Assert.IsTrue(MarginOfError(star.Spatial.Parallax, 193.20));
        }
